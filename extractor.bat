...
set "command_template=C:\Program Files\PeaZip\res\bin\7z\7z.exe x -aos -oC:\Users\Administrator\Downloads\New folder -bb0 -bse0 -bsp2 -p@fatecloud -sccUTF-8 -snz %%filename%% -r -- *password*.txt"
